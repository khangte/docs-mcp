...
- 관련: `docs/architect-review/05_embedding_provider_local_model_design.md`(로컬 임베딩 전환 설계), `docs/architect-review/07_search_rrf_reevaluation.md`(RRF 융합), `docs/supabase-migration-review.md`(원격/추가 서비스 정당성 판단 선례 — 커밋 `52636bd`에서 삭제됨)
