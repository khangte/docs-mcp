...
- 일시: 2026-08-08
- 작성: architect
- 관련: `docs/architect-review/03-search-performance-improvements.md`(상위 제안 RRF), `docs/architect-review/04-search-p1-keyword-fts-design.md`, ADR-0002, SPEC Phase 0 결정 6
...
> `docs/architect-review/09-search-quality-post-rrf.md`의 P1(커밋 `97f3c2d`·`731d43c`)이 평가셋을 84질의로
