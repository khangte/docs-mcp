...
- 관련: `docs/architect-review/06-vector-store-qdrant-vs-pgvector.md`, `docs/supabase-migration-review.md`, `docs/architect-review/05-embedding-provider-local-model-design.md`(구현 완료 커밋 `be774dd`)
