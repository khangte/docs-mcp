...
- 상태: accepted
- 일시: 2026-08-08
- 관련: `docs/architect-review/05-embedding-provider-local-model-design.md`, ARCHITECTURE.md §7, ADR-0002
...
- Qdrant 등 별도 벡터 DB 로의 전환은 검토했으나 비권장으로 결론 내렸다
  (`docs/architect-review/06-vector-store-qdrant-vs-pgvector.md`) — pgvector 유지, 컬럼/인덱스
  구조는 그대로 두고 차원만 바꿨다.
