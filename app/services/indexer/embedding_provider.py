...
#: `docs/architect-review/16_long_section_chunking_blindspot.md` §1-2·§2-4: SentenceTransformer
...
#: `docs/architect-review/23_long_section_sub_chunking_phase2_design.md` §5:
