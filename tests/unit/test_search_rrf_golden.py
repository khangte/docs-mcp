"""RRF 도입 순위 골든 회귀 테스트(`docs/architect-review/07_search_rrf_reevaluation.md` 5절, 5.6).
...
def test_rrf_strategy_golden_ranking(app_state, sample_openapi_3: str) -> None:
    ...
    `docs/architect-review/07_search_rrf_reevaluation.md` 5.4 명세대로 결정적이지만, 입력값이
